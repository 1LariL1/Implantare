    ...
    <main>
        <div class="admin-container">
            ...
            <div class="container">
                ...
                <form action="../../php/create/create-doctor.php" method="post" enctype="multipart/form-data">
                    <div class="admin-box">
                        <div class="admin-wrap">
                            <div class="admin-label">
                                <label>Имя</label>
                            </div>
                            <input type="text" name="docName" class="admin-input" required>
                        </div>
                        ...
                        <div class="admin-wrap">
                            ...
                            <input type="text" name="docSurname" class="admin-input" required>
                        </div>
                        ...
                        <div class="admin-wrap">
                            ...
                            <input type="text" name="docPatronymic" class="admin-input" required>
                        </div>
                        ...
                        <div class="admin-wrap">
                            ...
                            <input type="text" name="docWE" class="admin-input" required>
                        </div>
                        ...
                        <div class="admin-wrap">
                            ...
                            <input type="text" name="docSpec" class="admin-input" required>
                        </div>
                        ...
                        <div class="admin-wrap">
                            ...
                            <input type="number" name="docTel" class="admin-input" required>
                        </div>
                    </div>
                    <div class="admin-wrap" style="margin-top: 20px; width: 207px;">
                            <div class="admin-label">
                                <label>Фотография</label>
                            </div>
                            <label for="files" style="cursor: pointer; display: flex; align-items: center;" class="admin-input" required>
                                <img src="../../image/upload-03.png" alt="Загрузить файл">
                                <div id="file-name"  style="margin-left: 5px;"></div>
                            </label>
